...
import {DataFormat, Property, Service, ValueRange, ValueList, ValueDefinition} from '@jd/xiot-core-spec-ts';
...
@Component({
  selector: 'editor-service-property',
  templateUrl: './editor.service.property.component.html',
  styleUrls: ['./editor.service.property.component.less'],
  standalone: true,
  imports: [
    FormsModule,
    ReactiveFormsModule,
...
export class EditorServicePropertyComponent implements OnInit, OnChanges {
