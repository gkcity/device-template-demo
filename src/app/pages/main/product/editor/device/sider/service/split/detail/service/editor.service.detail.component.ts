...
@Component({
  selector: 'editor-service-detail',
  templateUrl: './editor.service.detail.component.html',
  styleUrls: ['./editor.service.detail.component.less'],
  standalone: true,
  imports: [
    FormsModule,
    ReactiveFormsModule,
...
export class EditorServiceDetailComponent implements OnInit {
