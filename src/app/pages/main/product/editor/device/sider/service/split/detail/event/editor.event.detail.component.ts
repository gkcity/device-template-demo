...
@Component({
  selector: 'editor-service-event',
  templateUrl: './editor.event.detail.component.html',
  styleUrls: ['./editor.event.detail.component.less'],
  standalone: true,
  imports: [
    FormsModule,
    ReactiveFormsModule,
...
export class EditorEventDetailComponent implements OnInit, OnChanges {
