...
import {Action, Argument, Property, Service} from '@jd/xiot-core-spec-ts';
...
import {EditorServicePropertyMemberComponent} from '../property/member/editor.service.property.member.component';
import {EditorServiceActionArgumentComponent} from './argument/editor.service.action.argument.component';
import {SelectMemberComponent} from '../../../../../common/dialog/select/member/select.member.component';
import {SelectMember} from '../../../../../common/dialog/select/member/SelectMember';
...
@Component({
  selector: 'editor-service-action',
  templateUrl: './editor.action.detail.component.html',
  styleUrls: ['./editor.action.detail.component.less'],
  standalone: true,
  imports: [
    FormsModule,
    ReactiveFormsModule,
...
export class EditorActionDetailComponent implements OnInit, OnChanges {
